...
from functions import step_scheduler as scheduler
...
class FormationController:
    def __init__(self, data_recorder, traci, splitting_agent='predict', collecting_agent='predict',
                 exp_name='default_run', learning_rate=5e-4, train_interval=32, model_name=None):
        '''
        ...
        self.scheduler = scheduler.StepScheduler()
