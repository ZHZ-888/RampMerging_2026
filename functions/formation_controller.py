from functions import platoon_formation2 as pform
...
class FormationController:
    def __init__(self, data_recorder, traci):
        ...
        self.p_formation = pform.PlatoonForm(traci, data_recorder)
        # RL module
    ...
    def step(self, st, step, lc):
        ...
        self.data_recorder.ls_m_leader_his_asc = list(his_dic_platoon_size.keys())
        # record dic_platoon_members
        dic_member_to_leader = self.p_formation.update_member_to_leader(dic_platoon_members)
        ...
        ls_leader_mc, dic_follower_state, dic_final_platoon_info = (
            self.p_formation.record_follower_state2(step, length_ih, dic_tags, ls_ihA))
        # control gaps between platoons
        self.p_formation.form_platoon3(ls_leader_AV, ls_follower_AV)
        self.p_formation.restrict_auto_lc(ls_ihAB_av)
        self.p_formation.restore_speed_limit2(ls_centerA_av)
