...
# import print_control as prc # the shared fuction of print control
from functions import print_control as prc # the shared fuction of print control

# add constraint4 to make sure velocity always >= 0
class GetBVCurve:
    def __init__(self, v0, t, dis=200):
        self.dis = dis
        self.v0 = v0
        self.t = t
    ...
    def constraint4(self, x):
        ...
        v1 = self.v0 + a1 * t1
        v3 = v1 + a3 * t3
        # Ensure no negative velocities at each stage
        return min(v1, v3)
    ...
    def optimize(self):
        cons = ({'type': 'eq', 'fun': self.constraint1},
                ...
                {'type': 'ineq', 'fun': self.constraint4})  # added velocity non-negative constraint
        ...
        v_rem = -sol.fun # v_reaching_mav
        prc.print_message('Maximum value of final velocity vt:', v_rem)
        prc.print_message('Optimal solution:', sol.x)  # t1, a1, t3, a3
        return sol, v_rem   

# add min speed limit 2024.6.6    
class GetBVCurve2:
    def __init__(self, v0, t, dis=200, min_speed=0):
        self.dis = dis
        self.v0 = v0
        self.t = t
        self.max_speed = 25
    ...
    def optimize(self):
        ...
        prc.print_message("\n*Optimiser result*")
        prc.print_message('Final speed:', v_rem)
        prc.print_message('Optimal solution:', sol.x)  # t1, a1, t3, a3
        return sol, v_rem
