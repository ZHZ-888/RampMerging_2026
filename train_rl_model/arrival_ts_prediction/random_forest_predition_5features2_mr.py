...
# df_ft = pd.read_csv('/home/zzha/PycharmProjects/RampMerging3/data/df_combined_mr_4f_241122.csv')
df_ft = pd.read_csv('/home/zzha/PycharmProjects/RampMerging3/data/df_combined_mr_4f_241128.csv')
print(len(df_ft))
df_train_test = df_ft
...
X = df_train_test[['platoon_type', 'dis_leader_pv', 'leader_v', 'leader_r_dis', 'm']]
...
#%% save the model
joblib.dump(model, '/home/zzha/PycharmProjects/RampMerging3/Models/mr_arrival_prediction_model241128.pkl')
